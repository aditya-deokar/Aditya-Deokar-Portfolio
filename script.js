document.addEventListener("DOMContentLoaded", function () {
  ...
  function locomotiveAnimation() {
    ...
    document.querySelectorAll('.left-menu h1 ,.right-menu h1,.logo').forEach(function (heading) {
  ...
  function page4Animation() {
    ...
    if (isMobile) {
      ...
      tl.to("#page1", {
         top: "40%", width: "90%", height: "85vh", borderRadius: "50px" 
        }, 'a');
      tl.to("#page2", {
         top: "110%" 
        }, 'a');
      ...
      tl.to("#page1", {
         width: "76%", height: "85vh" 
        }, 'b');
      tl.to("#page2", {
         top: "45%", borderRadius: "50px", width: "90%" 
        }, 'b');
      tl.to("#page3", {
         top: "130%" 
        }, 'b');
      ...
      tl.to("#page2", {
         width: "84%", height: "86vh" 
        }, 'c');
      tl.to("#page3", {
         top: "50%", borderRadius: "50px", width: "90%" 
        }, 'c');
    }
  }
